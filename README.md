...
```bash
curl -sL [https://raw.githubusercontent.com/HanaaCanss/winhana/Hanaaa/winhana.sh](https://raw.githubusercontent.com/HanaaCanss/winhana/Hanaaa/winhana.sh) | sudo bash
```
